...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','category','vendor','name','description','price','stock_quantity','product_ratings']
        depth = 1
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        many=True
        model = models.Product
        fields = ['id','category','vendor','name','description','price','stock_quantity','product_ratings','product_images']
        depth = 1
